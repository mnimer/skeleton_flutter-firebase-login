...
import 'package:list_collections/pages/login_page.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  //todo: put authState.value (firebase user) into UserProvider

  return GoRouter(
    navigatorKey: _key,
    debugLogDiagnostics: true,
    initialLocation: SplashPage.routeLocation, //todo start on splash page
    routes: [
      GoRoute(
